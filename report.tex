...
\begin{equation}
  D_\mu \coloneq \partial_\mu + ie\Lambda_\mu
\end{equation}
\begin{equation}
...
\begin{equation}
  \Lambda_\mu \mapsto \Lambda_\mu -\frac{1}{e}\partial_\mu\vartheta(x)
\end{equation}
Thus we have a modified Lagrangian which admits a local $\mathrm{U}(1)$ gauge symmetry
\begin{equation}
  \mathcal{L} =  \bar{\psi}(i \gamma^\mu\partial_\mu - m)\psi -e\Lambda_\mu j^\mu
\end{equation}
...
and field tensor respectively. Thus we identify $\Lambda_\mu = A_\mu$ and $ej^\mu = J^\mu$
