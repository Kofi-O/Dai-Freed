...
TO INDICATE A TIME-ORDERED PROD][ADD PROOF L8R]
\begin{equation}
...
\end{equation}
where we define the commutator in the time-ordered product as
\begin{equation}
...
\end{equation}
\textcolor{red}{See appendix for proof}.
...
These delta function terms are called Schwinger/contact terms 
