...
\begin{equation}
  \partial^x_{\mu}\!\Braket{j^\mu(x)\prod^n_{i=1}{\mathcal{O}_i(z_i)}} = 0 \quad ;\quad x \neq z_k
\end{equation}
\textcolor{red}{These relations must hold otherwise renormalisability of QFT is lost.
However, showing they dont hold requires feynman diagrams which is beyond us, might have to
switch to index thrm}
